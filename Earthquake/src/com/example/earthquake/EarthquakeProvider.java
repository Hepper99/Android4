...
public class EarthquakeProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI = Uri.parse("content://com.example.earthquake/earthquakes");
  ...
  EarthquakeDatabaseHelper dbHelper;
	...
	public boolean onCreate() {
		dbHelper = new EarthquakeDatabaseHelper(getContext(), EarthquakeDatabaseHelper.DATABASE_NAME, null, EarthquakeDatabaseHelper.DATABASE_VERSION);		
		return true;
	}
